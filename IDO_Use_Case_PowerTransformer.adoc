...
[#fig-power-transformer-winding, title="Stacking of laminated steel sheets to form the magnetic core of a three-phase power transformer. Author: Fluppe37. Public Domain, CC BY-SA 3.0 via Wikimedia Commons<br>",link=https://commons.wikimedia.org/wiki/File:Kern_722.jpg]
